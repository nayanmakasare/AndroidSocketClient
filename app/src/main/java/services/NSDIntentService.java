 ...
 * helper methods.
 */
public class NSDIntentService extends IntentService {
    ...
    public NSDIntentService() {
        super("NSDIntentService");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, NSDIntentService.class);
